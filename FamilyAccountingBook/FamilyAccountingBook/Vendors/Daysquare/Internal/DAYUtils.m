...
+ (NSString *)stringOfWeekdayInEnglish:(NSUInteger)weekday {
    ...
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        Strings = @[NSLocalizedString(@"Sun",nil), NSLocalizedString(@"Mon",nil), NSLocalizedString(@"Tues",nil), NSLocalizedString(@"Wed",nil), NSLocalizedString(@"Thur",nil), NSLocalizedString(@"Fri",nil), NSLocalizedString(@"Sat",nil)];
    });
...
+ (NSString *)stringOfMonthInEnglish:(NSUInteger)month {
    ...
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        Strings = @[NSLocalizedString(@"Jan.",nil), NSLocalizedString(@"Feb.",nil), NSLocalizedString(@"Mar.",nil), NSLocalizedString(@"Apr.",nil), NSLocalizedString(@"May.",nil), NSLocalizedString(@"Jun.",nil), NSLocalizedString(@"Jul.",nil), NSLocalizedString(@"Aug.",nil), NSLocalizedString(@"Sept.",nil), NSLocalizedString(@"Oct.",nil), NSLocalizedString(@"Nov.",nil), NSLocalizedString(@"Dec.",nil)];
    });
