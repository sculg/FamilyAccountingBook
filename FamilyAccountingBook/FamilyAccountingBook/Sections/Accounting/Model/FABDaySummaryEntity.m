...
@implementation FABDaySummaryEntity

-(NSInteger)periodRecordNum{
    LKDBHelper* globalHelper = [FABAccountingRecentRecordEntity getUsingLKDBHelper];
    NSArray *myRecordArray = [globalHelper search:[FABAccountingRecentRecordEntity class] where:@{@"recordTime":self.selectedDate} orderBy:nil offset:0 count:1000];
...
-(double)incomeSum{
    ...
    double sum = 0;
    myRecordArray = [globalHelper search:[FABAccountingRecentRecordEntity class] where:@{@"recordTime":self.selectedDate,@"accountingType":@(0)} orderBy:@"recordId desc" offset:0 count:1000];
...
-(double)expenditureSum{
    ...
    NSArray *myRecordArray ;
    double sum = 0;
    myRecordArray = [globalHelper search:[FABAccountingRecentRecordEntity class] where:@{@"recordTime":self.selectedDate,@"accountingType":@(1)} orderBy:@"recordId desc" offset:0 count:1000];
...
-(double)inquireIncomeSumWithType:(NSInteger)typeId{
    ...
    NSArray *myRecordArray ;
    double sum = 0;
    myRecordArray = [globalHelper search:[FABAccountingRecentRecordEntity class] where:@{@"recordTime":self.selectedDate,@"incomeClassificationType":@(typeId)} orderBy:@"recordTime desc" offset:0 count:1000];
    for (FABAccountingRecentRecordEntity *entity in myRecordArray) {
        sum += [entity.recordMoney doubleValue];
    }
    return sum;
...
-(double)inquireEpenditureSumWithType:(NSInteger)typeId{
    ...
    myRecordArray = [globalHelper search:[FABAccountingRecentRecordEntity class] where:@{@"recordTime":self.selectedDate,@"ependitureClassificationType":@(typeId)} orderBy:@"recordId desc" offset:0 count:1000];
    for (FABAccountingRecentRecordEntity *entity in myRecordArray) {
        sum += [entity.recordMoney doubleValue];
    }
    return sum;
...
-(double)inquireEpenditureSumWithPayType:(NSInteger)typeId{
    ...
    myRecordArray = [globalHelper search:[FABAccountingRecentRecordEntity class] where:@{@"recordTime":self.selectedDate,@"payType":@(typeId),@"accountingType":@(1)} orderBy:@"recordId desc" offset:0 count:1000];
    for (FABAccountingRecentRecordEntity *entity in myRecordArray) {
        sum += [entity.recordMoney integerValue];
    }
    return sum;
}
...
-(double)inquireEpenditureSumWithObjectType:(NSInteger)typeId{
    ...
    myRecordArray = [globalHelper search:[FABAccountingRecentRecordEntity class] where:@{@"recordTime":self.selectedDate,@"expenditureObjectType":@(typeId),@"accountingType":@(1)} orderBy:@"recordTime desc" offset:0 count:1000];
    for (FABAccountingRecentRecordEntity *entity in myRecordArray) {
        sum += [entity.recordMoney doubleValue];
    }
    return sum;
